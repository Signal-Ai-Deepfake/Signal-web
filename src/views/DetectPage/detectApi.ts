...
export async function createDeepfakeDetection(file: File): Promise<DeepfakeDetectionCreateResponse> {
...
export async function getDeepfakeDetection(detectionId: number): Promise<DeepfakeDetectionResponse> {
