    ...
    <div className="flex h-[458px] w-full flex-col gap-4 rounded-2xl border border-gray-300 p-8 lg:max-w-[640px]">
      {status !== "idle" && previewUrl ? (
          ...
          <div className="relative min-h-0 flex-1 overflow-hidden rounded-xl">
            ...
            {status === "analyzing" && (
              <div className="absolute inset-0 flex flex-col items-center justify-center gap-3 bg-white/90">
                ...
                <p className="text-body-1 font-semibold text-black">분석 중...</p>
              </div>
            )}
          </div>
        ...
        <div
          ...
          onDrop={handleDrop}
          className={`flex h-full flex-col items-center justify-center gap-6 rounded-xl border-2 border-dashed transition-colors ${
